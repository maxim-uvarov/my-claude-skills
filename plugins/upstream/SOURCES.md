...
| --- | --- | --- | --- |
| `doc-coauthoring` | `anthropics/skills` → `skills/doc-coauthoring` | `0075614` (2025-12-04); repo HEAD then `b29e7cf` | Apache 2.0 per repo README; the repo carries no `LICENSE` file and no per-skill header, so this is the README's blanket claim, not a marked license |
